...
// to properly set up the template for HANARO Data Reduction, the dummy
// function HANARO() must exist here in the Includes file.
//
Function HANARO()
	//does nothing but define HANARO()
	return(0)
End
...
#include "HANARO_Utils_1024"									//new in the 29MAR07 branch
#include "HANARO_DataReadWrite"							//new in the 29MAR07 branch
